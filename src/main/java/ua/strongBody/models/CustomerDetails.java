...
public class CustomerDetails implements UserDetails {
    ...
    public CustomerDetails(String password, String username, boolean accountNonExpired, boolean accountNonLocked, boolean credentialsNonExpired, boolean enabled, Role role) {
